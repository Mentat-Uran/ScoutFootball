...
SQUADS: dict[str, list[dict]] = {
    ...
    "Argentina": [
        ...
        {"name": "Alejandro Garnacho", "position": "W", "club": "Manchester United", "club_league": "Premier League"},
        {"name": "Marcos Acuna", "position": "FB", "club": "Sevilla", "club_league": "La Liga"},
        {"name": "Giovani Lo Celso", "position": "AM", "club": "Betis", "club_league": "La Liga"},
        ...
        {"name": "Exequiel Palacios", "position": "CM", "club": "Leverkusen", "club_league": "Bundesliga"},
        {"name": "Nehuen Perez", "position": "CB", "club": "Udinese", "club_league": "Serie A"},
        {"name": "Valentin Barco", "position": "FB", "club": "Brighton", "club_league": "Premier League"},
    ],
    "Australia": [
    ...
    "Brazil": [
        ...
        {"name": "Douglas Luiz", "position": "CM", "club": "Juventus", "club_league": "Serie A"},
        {"name": "Gabriel Martinelli", "position": "W", "club": "Arsenal", "club_league": "Premier League"},
        {"name": "Savinho", "position": "W", "club": "Manchester City", "club_league": "Premier League"},
        {"name": "Joao Gomes", "position": "CM", "club": "Wolves", "club_league": "Premier League"},
        {"name": "Andrey Santos", "position": "CM", "club": "Strasbourg", "club_league": "Ligue 1"},
        {"name": "Guilherme Arana", "position": "FB", "club": "Atletico Mineiro", "club_league": "Brasileirao"},
        {"name": "Wendell", "position": "FB", "club": "Porto", "club_league": "Liga Portugal"},
        {"name": "Bento", "position": "GK", "club": "Athletico Paranaense", "club_league": "Brasileirao"},
        {"name": "Murillo", "position": "CB", "club": "Nott'm Forest", "club_league": "Premier League"},
        {"name": "Igor Julio", "position": "CB", "club": "Brighton", "club_league": "Premier League"},
    ],
    "Canada": [
    ...
    "England": [
        ...
        {"name": "Marc Guehi", "position": "CB", "club": "Crystal Palace", "club_league": "Premier League"},
        {"name": "Levi Colwill", "position": "CB", "club": "Chelsea", "club_league": "Premier League"},
        {"name": "Kobbie Mainoo", "position": "CM", "club": "Manchester United", "club_league": "Premier League"},
        {"name": "Eberechi Eze", "position": "AM", "club": "Crystal Palace", "club_league": "Premier League"},
        {"name": "Aaron Ramsdale", "position": "GK", "club": "Southampton", "club_league": "Premier League"},
        {"name": "Luke Shaw", "position": "FB", "club": "Manchester United", "club_league": "Premier League"},
        {"name": "Jarrod Bowen", "position": "W", "club": "West Ham", "club_league": "Premier League"},
        ...
        {"name": "Rico Lewis", "position": "FB", "club": "Manchester City", "club_league": "Premier League"},
        {"name": "Conor Gallagher", "position": "CM", "club": "Atletico Madrid", "club_league": "La Liga"},
        {"name": "Ezri Konsa", "position": "CB", "club": "Aston Villa", "club_league": "Premier League"},
        {"name": "Anthony Gordon", "position": "W", "club": "Newcastle", "club_league": "Premier League"},
    ],
    "France": [
        ...
        {"name": "Aurelien Tchouameni", "position": "CM", "club": "Real Madrid", "club_league": "La Liga"},
        ...
        {"name": "Adrien Rabiot", "position": "CM", "club": "Marseille", "club_league": "Ligue 1"},
        {"name": "N'Golo Kante", "position": "DM", "club": "Al-Ittihad", "club_league": "SPL"},
        {"name": "Bradley Barcola", "position": "W", "club": "PSG", "club_league": "Ligue 1"},
        {"name": "Randal Kolo Muani", "position": "ST", "club": "Juventus", "club_league": "Serie A"},
        {"name": "Christopher Nkunku", "position": "AM", "club": "Chelsea", "club_league": "Premier League"},
        {"name": "Ibrahima Konate", "position": "CB", "club": "Liverpool", "club_league": "Premier League"},
        {"name": "Lucas Hernandez", "position": "CB", "club": "PSG", "club_league": "Ligue 1"},
        {"name": "Ferland Mendy", "position": "FB", "club": "Real Madrid", "club_league": "La Liga"},
        ...
        {"name": "Alphonse Areola", "position": "GK", "club": "West Ham", "club_league": "Premier League"},
        {"name": "Warren Zaire-Emery", "position": "CM", "club": "PSG", "club_league": "Ligue 1"},
        {"name": "Leny Yoro", "position": "CB", "club": "Manchester United", "club_league": "Premier League"},
    ],
    "Germany": [
        {"name": "Jamal Musiala", "position": "AM", "club": "Bayern Munich", "club_league": "Bundesliga"},
        {"name": "Florian Wirtz", "position": "AM", "club": "Leverkusen", "club_league": "Bundesliga"},
        {"name": "Ilkay Gundogan", "position": "CM", "club": "Manchester City", "club_league": "Premier League"},
        ...
        {"name": "Nico Schlotterbeck", "position": "CB", "club": "Dortmund", "club_league": "Bundesliga"},
        {"name": "Jonathan Tah", "position": "CB", "club": "Leverkusen", "club_league": "Bundesliga"},
        {"name": "Robin Gosens", "position": "FB", "club": "Fiorentina", "club_league": "Serie A"},
        {"name": "Niklas Sule", "position": "CB", "club": "Dortmund", "club_league": "Bundesliga"},
        {"name": "Serge Gnabry", "position": "W", "club": "Bayern Munich", "club_league": "Bundesliga"},
        {"name": "Thomas Muller", "position": "AM", "club": "Bayern Munich", "club_league": "Bundesliga"},
        {"name": "Pascal Gross", "position": "CM", "club": "Dortmund", "club_league": "Bundesliga"},
        {"name": "Robert Andrich", "position": "DM", "club": "Leverkusen", "club_league": "Bundesliga"},
        {"name": "Waldemar Anton", "position": "CB", "club": "Stuttgart", "club_league": "Bundesliga"},
        {"name": "Maximilian Mittelstadt", "position": "FB", "club": "Stuttgart", "club_league": "Bundesliga"},
        {"name": "Benjamin Henrichs", "position": "FB", "club": "RB Leipzig", "club_league": "Bundesliga"},
        {"name": "Deniz Undav", "position": "ST", "club": "Stuttgart", "club_league": "Bundesliga"},
        {"name": "Marc-Andre ter Stegen", "position": "GK", "club": "Barcelona", "club_league": "La Liga"},
        {"name": "Aleksandar Pavlovic", "position": "CM", "club": "Bayern Munich", "club_league": "Bundesliga"},
        {"name": "Nico Williams", "position": "FB", "club": "West Ham", "club_league": "Premier League"},
    ],
    "Ghana": [
    ...
    "Netherlands": [
        ...
        {"name": "Jeremie Frimpong", "position": "FB", "club": "Liverpool", "club_league": "Premier League"},
        {"name": "Donyell Malen", "position": "W", "club": "Dortmund", "club_league": "Bundesliga"},
        {"name": "Wout Weghorst", "position": "ST", "club": "Ajax", "club_league": "Eredivisie"},
        {"name": "Brian Brobbey", "position": "ST", "club": "Ajax", "club_league": "Eredivisie"},
        {"name": "Micky van de Ven", "position": "CB", "club": "Tottenham", "club_league": "Premier League"},
        {"name": "Stefan de Vrij", "position": "CB", "club": "Inter Milan", "club_league": "Serie A"},
        ...
        {"name": "Tijjani Reijnders", "position": "CM", "club": "AC Milan", "club_league": "Serie A"},
        {"name": "Steven Bergwijn", "position": "W", "club": "Ajax", "club_league": "Eredivisie"},
        {"name": "Daley Blind", "position": "CB", "club": "Girona", "club_league": "La Liga"},
        {"name": "Ian Maatsen", "position": "FB", "club": "Aston Villa", "club_league": "Premier League"},
        {"name": "Joey Veerman", "position": "CM", "club": "PSV", "club_league": "Eredivisie"},
    ],
    "New Zealand": [
    ...
    "Portugal": [
        ...
        {"name": "Francisco Trincao", "position": "W", "club": "Sporting CP", "club_league": "Liga Portugal"},
        ...
        {"name": "Danilo Pereira", "position": "DM", "club": "PSG", "club_league": "Ligue 1"},
        {"name": "Goncalo Ramos", "position": "ST", "club": "PSG", "club_league": "Ligue 1"},
        {"name": "Joao Palhinha", "position": "DM", "club": "Bayern Munich", "club_league": "Bundesliga"},
        {"name": "Rui Patricio", "position": "GK", "club": "Roma", "club_league": "Serie A"},
        ...
        {"name": "Otavio", "position": "AM", "club": "Al-Nassr", "club_league": "SPL"},
        {"name": "Ricardo Horta", "position": "W", "club": "Braga", "club_league": "Liga Portugal"},
        {"name": "Nelson Semedo", "position": "FB", "club": "Wolves", "club_league": "Premier League"},
        {"name": "Bruma", "position": "W", "club": "Braga", "club_league": "Liga Portugal"},
    ],
    "Qatar": [
    ...
    "Spain": [
        ...
        {"name": "Dani Carvajal", "position": "FB", "club": "Real Madrid", "club_league": "La Liga"},
        ...
        {"name": "Alex Grimaldo", "position": "FB", "club": "Leverkusen", "club_league": "Bundesliga"},
        {"name": "Joselu", "position": "ST", "club": "Al-Gharafa", "club_league": "Qatar Stars League"},
        ...
        {"name": "Pau Torres", "position": "CB", "club": "Aston Villa", "club_league": "Premier League"},
        {"name": "Mikel Merino", "position": "CM", "club": "Arsenal", "club_league": "Premier League"},
        {"name": "Bryan Zaragoza", "position": "W", "club": "Osasuna", "club_league": "La Liga"},
        {"name": "Alejandro Balde", "position": "FB", "club": "Barcelona", "club_league": "La Liga"},
        {"name": "Yeremy Pino", "position": "W", "club": "Villarreal", "club_league": "La Liga"},
    ],
    "Sweden": [
