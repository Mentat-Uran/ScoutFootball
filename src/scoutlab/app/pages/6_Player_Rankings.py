...
from scoutlab.evaluation.coverage_confidence import display_confidence_badge
from scoutlab.evaluation.position_metrics import (
    POSITION_GROUP_MAP,
    compute_player_position_metrics,
)
from scoutlab.viz.pitch import plot_pizza_chart
...
if league_col in player_row.index and season_col and season_col in player_row.index:
    from scoutlab.evaluation.coverage_confidence import assess_league_season
